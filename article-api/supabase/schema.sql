...
CREATE TABLE IF NOT EXISTS "public"."public_todos" (
...
ALTER TABLE "public"."public_todos" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."public_todos"
    ADD CONSTRAINT "public_todos_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."public_todos" TO "anon";
GRANT ALL ON TABLE "public"."public_todos" TO "authenticated";
GRANT ALL ON TABLE "public"."public_todos" TO "service_role";
